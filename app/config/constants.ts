...
export const SITE_CONFIG = {
  name: 'Marcus Wein',
  description: 'Software Developer & AI Researcher based in Doha, Qatar. Building meaningful software solutions that merge design, AI, and research.',
  url: 'https://marcuswein.com',
  author: 'Marcus Wein',
  keywords: 'software developer, AI researcher, frontend developer, Qatar University, computer science, machine learning, React, Next.js, Python',
...
export const LANDING_PAGE = {
  headerTitle: '(Software Dev. & Researcher)',
  landingDescription: 'A builder at heart. From coding software and AI systems to crafting Gundams on my desk, I am a student who thrives on turning pieces into something greater than the sum of its parts.',
...
export const ABOUT_ME = {
  blurb: 'Not your typical CS student — growing up as a Filipino in Qatar taught me to see the world differently, and now I channel that into building tech with impact.',
  paragraphs: [
