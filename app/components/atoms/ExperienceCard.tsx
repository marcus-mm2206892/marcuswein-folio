...
export default function ExperienceCard({
  ...
  return (
    ...
    >
      <motion.div
        className="card group relative h-[600px] w-[700px] max-w-[90vw] rounded-3xl overflow-hidden border border-transparent hover:border-white/30 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] transition-[border,box-shadow] duration-500"
        style={{
          scale,
      ...
      >
        ...
        {/* Content Section */}
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 pb-8 overflow-hidden">
            ...
            <div className="space-y-3 sm:space-y-4">
              {description.map((item, index) => (
                ...
                >
                  ...
                  <p className="text-white/90 text-xs sm:text-base leading-relaxed break-words">
                    {item}
                  </p>
                </div>
              ))}
